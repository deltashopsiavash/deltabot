...
function getAdminKeys(){
    ...
    if($from_id == $admin){
        $keys[] = [['text'=>$buttonValues['admins_list'],'callback_data'=>"adminsList"]];
    }
    $keys[] = [
    ...
    $keys[] = [['text'=>$buttonValues['search_admin_config'],'callback_data'=>"searchUsersConfig"]];
    $keys[] = [['text'=>$buttonValues['server_settings'],'callback_data'=>"serversSetting"]];
    $keys[] = [['text'=>$buttonValues['categories_settings'],'callback_data'=>"categoriesSetting"]];
    $keys[] = [['text'=>$buttonValues['plan_settings'],'callback_data'=>"backplan"]];
    $keys[] = [
    ...
    $keys[] = [['text'=>$buttonValues['message_to_all'],'callback_data'=>"message2All"]];
    $keys[] = [['text'=>$buttonValues['forward_to_all'],'callback_data'=>"forwardToAll"]];
    $keys[] = [
...
function getRenameButtonsKeys($page=0){
    global $buttonValues, $connection, $buttonValues;
    $keys = array();
    $btnKeys = array_keys($buttonValues);
    // add start_message pseudo key
    ...
    foreach($slice as $k){
        ...
        $keys[] = [['text'=>$title,'callback_data'=>"renameBtnKey_" . $k]];
    }
    $nav = array();
