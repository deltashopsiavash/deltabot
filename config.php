...
function bot($method, $datas = []){
    global $botToken;
    // Telegram expects reply_markup as a JSON-encoded string. If caller passed an array, encode it.
...
function getBotSettingKeys(){
    ...
    $resellerShopState = (($botState['resellerBotState'] ?? 'on')=='on')?$buttonValues['on']:$buttonValues['off'];
    ...
    return json_encode(['inline_keyboard'=>[
        ...
        [
            ['text'=> $resellerShopState,'callback_data'=>"changeBotresellerBotState"],
            ['text'=>"ربات نمایندگی",'callback_data'=>"deltach"]
            ],
        [
