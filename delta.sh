...
# ---- ensure backup notification endpoint exists ----
if [ -f /var/www/html/deltabot/backupnutif.php ]; then
  cp -f /var/www/html/deltabot/backupnutif.php /var/www/html/backupnutif.php
  chown www-data:www-data /var/www/html/backupnutif.php 2>/dev/null || true
  chmod 644 /var/www/html/backupnutif.php 2>/dev/null || true
fi
